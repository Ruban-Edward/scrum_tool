 ...
 * 
 * @modified-by Jeeva
 * @created-date 07-07-2024
 * @modified-date 09-07-2024
 * 
 */
?>
<!-- <pre>
...
<!-- ASSERT_PATH ?>sprint/navsprintview?sprint_id= //$_GET['sprint_id'] -->
<form id="scrumRetrospectiveForm" action="<?= ASSERT_PATH ?>sprint/sprintretrospective?sprint_id=<?= $_GET['sprint_id'] ?>" method="post">
    ...
    <div class="container">
        <div class="feedback-section">
            <div class="feedback-type">
                ...
                <label>
                    <input type="radio" name="feedback-type" id="suggestions-input" value="lns"> Suggestions
                </label>
            </div>
            ...
            <div class="form-group">
                <div class="form-group-header" id="feedback-label"><h5 class="headerName"><i class="fas fa-clipboard"></i> General</h5></div>
